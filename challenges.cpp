...
bool Challenges::Set1Ch7z()
{
	...
	static const char* pInFile = "./data/set1/challenge7/AES_test_B64.txt";
	static const char* outputFile2 = "./data/set1/challenge7/AES_test.bin";
	...
	size_t nWritten = io_utils::writeBinFile(outputFile2, pBinBuf, binCnt);
